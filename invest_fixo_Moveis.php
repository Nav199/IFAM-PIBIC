...
class Movel extends Database
{
    ...
    public function CreateInves_Movel()
    {
        try {
            // O nome da tabela no banco de dados é usuarios(no plural), mas aqui no código estava no singular
            $stm = $this->connection->prepare("INSERT INTO movel (Descricao,Quantidade,valor,total) VALUES (:Descricao, :Quantidade, :valor, :total)");
